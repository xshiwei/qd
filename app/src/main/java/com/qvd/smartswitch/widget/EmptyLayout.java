...
//        getChildViews();
     ...
     * @param emptyMessage the message
     */
    private void setEmptyMessage(String emptyMessage) {
        this.mEmptyMessage = emptyMessage;
    }
     ...
     * @param loadingMessage the message
     */
    private void setLoadingMessage(String loadingMessage) {
        this.mLoadingMessage = loadingMessage;
    }
     ...
     */
    private void setErrorDrawable(int mErrorDrawable) {
     ...
     */
    private void setEmptyDrawable(int mEmptyDrawable) {
     ...
     */
    private void setLoadingDrawable(int mLoadingDrawable) {
        this.mLoadingDrawable = mLoadingDrawable;
    }

    private void getChildViews() {
        int childCount = getChildCount();
        Logger.d("EmptyLayout", "ChildCount:" + childCount);
        View view;
