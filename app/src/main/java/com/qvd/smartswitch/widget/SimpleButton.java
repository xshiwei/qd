...
public class SimpleButton extends View {
    ...
    // 3种外形模式：圆角矩形、圆弧、直角矩形
    private final static int SHAPE_ROUND_RECT = 101;
    private final static int SHAPE_ARC = 102;
    private final static int SHAPE_RECT = 103;
    // 类型模式：正常、可选中、图标选中消失、图标选中切换
    private final static int MODE_NORMAL = 201;
    private final static int MODE_CHECK = 202;
    private final static int MODE_ICON_CHECK_INVISIBLE = 203;
    private final static int MODE_ICON_CHECK_CHANGE = 204;
