...
public class MasterLayout extends FrameLayout implements OnClickListener {
    ...
    private void setAnimation() {
        ...
        ScaleAnimation scale_in = new ScaleAnimation(0.0f, 1.0f, 0.0f, 1.0f,
                Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,
                0.5f);
        ScaleAnimation scale_out = new ScaleAnimation(1.0f, 3.0f, 1.0f, 3.0f,
                Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,
                0.5f);
    ...
    private void iconCreate() {
        ...
        Path download_triangle = new Path();
        ...
        Path download_rectangle = new Path();
