...
import com.qvd.smartswitch.utils.MeasureUtils;
...
public class WaveProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mDefaultSize = MeasureUtils.dipToPx(context, ConfigUtils.DEFAULT_SIZE);
        mRectF = new RectF();
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mDarkWaveAnimTime = typedArray.getInt(R.styleable.WaveProgress_darkWaveAnimTime, ConfigUtils.DEFAULT_ANIM_TIME);
        mLightWaveAnimTime = typedArray.getInt(R.styleable.WaveProgress_lightWaveAnimTime, ConfigUtils.DEFAULT_ANIM_TIME);
        mMaxValue = typedArray.getFloat(R.styleable.WaveProgress_maxValue, ConfigUtils.DEFAULT_MAX_VALUE);
        mValue = typedArray.getFloat(R.styleable.WaveProgress_value, ConfigUtils.DEFAULT_VALUE);
        mValueSize = typedArray.getDimension(R.styleable.WaveProgress_valueSize, ConfigUtils.DEFAULT_VALUE_SIZE);
        ...
        mHintSize = typedArray.getDimension(R.styleable.WaveProgress_hintSize, ConfigUtils.DEFAULT_HINT_SIZE);

        mCircleWidth = typedArray.getDimension(R.styleable.WaveProgress_circleWidth, ConfigUtils.DEFAULT_ARC_WIDTH);
        mCircleColor = typedArray.getColor(R.styleable.WaveProgress_circleColorprogress, Color.GREEN);
        mBgCircleColor = typedArray.getColor(R.styleable.WaveProgress_bgCircleColor, Color.WHITE);

        mWaveHeight = typedArray.getDimension(R.styleable.WaveProgress_waveHeight, ConfigUtils.DEFAULT_WAVE_HEIGHT);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(MeasureUtils.measure(widthMeasureSpec, mDefaultSize),
                MeasureUtils.measure(heightMeasureSpec, mDefaultSize));
    }
    ...
    private Point[] getPoint(boolean isR2L, float waveWidth) {
        ...
        return isR2L ? MeasureUtils.reverse(points) : points;
    }
