...
public class DeviceSplashActivity extends BaseActivity {
    ...
    private void showPopupWindow() {
        ...
        popupWindow.setOnDismissListener(() -> CommonUtils.setBackgroundAlpha(DeviceSplashActivity.this, 1.0f));

        tv_item.setOnClickListener(v -> {
        ...
        tv_confirm.setOnClickListener(v -> UpdateConnectState());
                ...
                .subscribe(new Observer<MessageVo>() {
                    ...
                    public void onNext(MessageVo messageVo) {
                        if (messageVo.getCode() == 200) {
                            ...
                            finish();
                            ToastUtil.showToast(getString(R.string.common_accredit_fail));
                        }
                    }
