...
public class QsOneSoundControlActivity extends BaseActivity {
    ...
    private static String TAG = QsOneSoundControlActivity.class.getSimpleName();
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        ...
        public void onVolumeChanged(int volume, byte[] data) {
            if (volume < 10) {
                Picasso.with(QsOneSoundControlActivity.this).load(R.mipmap.voice_empty).into(ivSound);
            } else {
                Picasso.with(QsOneSoundControlActivity.this).load(R.mipmap.voice_full).into(ivSound);
            }
        }
